...
class GFG {
    ...
    public static void print(String display, int[][] matrix, int start_row, int start_column, int end_row,
            int end_column) {
    ...
    public static void main(String[] args) {
        ...
        int[][] matrix_A = createMatrix(1024);
        int[][] matrix_B = createMatrix(1024);
